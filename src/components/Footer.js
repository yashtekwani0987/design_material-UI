    ...
    <section className={`${style.flexCenter} ${style.paddingY} flex-col`}>
      <div className={`${style.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className="flex-1 flex flex-col justify-start mr-10">
          ...
          />
          <p className={`${style.paragraph} text-white mt-4 max-w-[310px]`}>
            ...
            >
              ...
              <ul className="list-none mt-4">
                {footerlink.links.map((link, index) => (
                  <li
                    key={link.name}
                    className={`font-poppins font-normal text-[16px] leading-[24px] text-white hover:text-skyblue cursor-pointer ${
